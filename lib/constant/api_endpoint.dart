...
String ITABLISSMENT_LOGO_URL(String establishmentId)=> "${BASE_URL}api/infos/logoEtablissement/$establishmentId";
String STUDENT_CARDS_URL (String uuid) => "${BASE_URL}api/infos/bac/$uuid/dias";
String EXAM_NOTES_URL (String cardId) => "${BASE_URL}api/infos/planningSession/dia/$cardId/noteExamens";
String CC_NOTES_URL (String cardId) => "${BASE_URL}api/infos/controleContinue/dia/$cardId/notesCC";
